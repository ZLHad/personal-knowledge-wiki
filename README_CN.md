...
一个交互式脚本。三个 Claude Code 技能。零数据库依赖。只有纯 Markdown 文件，随时间复利增长。

灵感来源：[Andrej Karpathy 的 LLM Wiki](https://gist.github.com/karpathy/1dd0294ef9567971c1e4348a90d69285) 模式、[GBrain](https://github.com/jmozzart/gbrain) 的编码化 lint 规则、[Obsidian](https://obsidian.md) 的本地优先理念。
...
**为什么要硬编码规则？** 受 [GBrain](https://github.com/jmozzart/gbrain) 启发。纯靠 LLM 判断不可靠——LLM 会"忘记"检查某些规则。8 条硬编码规则是 **确定性的**，每次都完整执行。软性分析（矛盾检测、薄弱页面、缺失链接）作为补充。
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  Step 4/5: 安装 Claude Code Skills
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
三个 skill 安装在 `~/.claude/skills/`，wiki 路径已硬编码。可以在 **任何项目目录** 下触发：
...
正如 [Karpathy 所说](https://x.com/karpathy/status/1761467904737067456)：磁盘上的纯文本文件，丰富的插件生态，与其他工具高度可组合。[Kepano（Obsidian CEO）建议](https://x.com/kepano/status/2039831289533227446)：Obsidian 是浏览器，Claude Code 是引擎。
...
│   └── log.md                 # 初始时间线模板
│
├── skills/                    # Claude Code Skills（安装到 ~/.claude/skills/）
│   ├── wiki-ingest/           # 知识摄入技能
│   │   ├── SKILL.md           # 技能定义
│   │   └── references/        # 提取策略指南
...
│
└── examples/                  # 示例 wiki 页面
    ├── entity-example.md      # 实体页示例（React）
    └── concept-example.md     # 概念页示例（DRY 原则）
```
...
- [Andrej Karpathy](https://gist.github.com/karpathy/1dd0294ef9567971c1e4348a90d69285) — LLM Wiki 模式和核心洞察
- [GBrain](https://github.com/jmozzart/gbrain) — 编码化 lint 规则的灵感
- [Obsidian](https://obsidian.md) — 本地优先的知识 IDE
- [Claude Code](https://claude.ai/code) — 驱动所有操作的 LLM 引擎
- [Kepano](https://x.com/kepano) — Obsidian CEO，vault 架构建议
